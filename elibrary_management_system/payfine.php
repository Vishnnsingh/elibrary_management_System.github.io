...
<body>
    ...
    <head>
        ...
        <script>
            function validateForm() {
                ...
                var fineCalculated = document.forms["bookIssueForm"]["finecalculated"].value;

                // Check if fields are empty
                if (bookName == "" || authorName == "" || serialNo == "" || issueDate == "" || returnDate == "" || actualReturnDate == "" || fineCalculated == "") {
                ...
                // Check if actual return date is not more than 15 days from today
                var returnLimit = new Date();
                returnLimit.setDate(returnLimit.getDate());
                if (returnDate > returnLimit.toISOString().substr(0, 10)) {
                    alert("Return date cannot be more than 15 days from today");
                    return false;
                }
    ...
    <form name="bookIssueForm" onsubmit="return validateForm()">
        ...
        <input type="date" id="actualReturnDate" name="actualReturnDate" required><br><br>

        <label for="fineCalculated">Fine Calculated:</label>
        <input type="text" id="fineCalculated" name="fineCalculated" required><br><br>

        <label for="fine-paid">Fine Paid:</label>
        <input type="checkbox" id="fine-paid" name="fine-paid"><br></br>
